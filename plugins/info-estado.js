...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} 𝐁𝐨𝐭 𝐌𝐞𝐥𝐬𝐢𝐭𝐚
  ${tradutor.texto1[2]} ++34611731555
  ${tradutor.texto1[3]} https://www.instagram.com/melsitaaaay
  ...
  const Message = {
    document: { url: `https://www.instagram.com/melsitaaaay` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/melsitaaaay",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐁𝐨𝐭 𝐌𝐞𝐥𝐬𝐢𝐭𝐚",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/melsitaaaay",
      },
    },
    caption: info,
    footer: wm,
